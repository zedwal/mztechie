...
<div class="content">
  <h2>Edit details of article</h2>
  <div class="entry">
    <g:form name="articleForm"
            controller="article" action="update">
      <g:hiddenField name="aid" value="${article?.id}" />
      <p>Article Title</p>
      <p><g:textArea name="atext"
                     rows="2" cols="51"
      ...
      <p><gui:autoComplete id="course" controller="course"
                           action="courseAutoComplete"
                           size="40"
                           value="${article?.course?.name}"/></p>

      <div class="clear">&nbsp;</div>
      <p> Details </p>
      <p><g:textArea name="details"
                     rows="20" cols="60"
                     value="${article?.details}"/></p>
      <p> Tags </p>
      <p><g:textField name="tags" size="40" value="${articleTags}"/></p>
